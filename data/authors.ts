...
const Authors: Author[] = [
  ...
  },
  {
    ...
    description:
    "Teal is a Full Stack Software Engineer with Grouparoo, an open source data framework that easily connects your data to business tools. She loves building products that solve real-world needs.  If she isn't writing code, Teal is probably riding her bike, wandering on a mountain, or nose-deep in a book.",
  }
];
