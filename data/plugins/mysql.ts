...
export const MySQL: Plugin = {
  ...
  dataModelDescription: [
    "Grouparoo's core objects are Records and Profile Properties. These objects are defined based on your data such as the data in your MySQL DB. You can pull this data in with Grouparoo's help or you can write SQL queries directly.",
