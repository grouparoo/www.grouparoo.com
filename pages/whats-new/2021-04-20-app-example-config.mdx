...
Following our release of Declarative Sync, we created [an example Grouparoo instance](https://github.com/grouparoo/app-example-config) to give Grouparoo a try before adding your data.
