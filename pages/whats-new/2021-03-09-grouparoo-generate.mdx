...
The generate command uses your input to write a configuration file to your file system. You can then use this file to configure the various objects in Grouparoo, like [Apps](/docs/config/code-config/apps), [Sources](/docs/config/code-config/sources), or [Destinations](/docs/config/code-config/destinations).
