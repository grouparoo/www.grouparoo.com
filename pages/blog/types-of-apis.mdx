...
Public APIs can either be free or may require registration and a fee per call depending on the provider. Some examples of [public APIs](https://github.com/public-apis/public-apis) include Archive.org’s search and book APIs, [Stripe's payments APIs](https://stripe.com/docs/api), and [Giphy's API](https://developers.giphy.com/docs/api#quick-start-guide).
