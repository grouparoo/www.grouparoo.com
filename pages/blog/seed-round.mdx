...
We will use our new funding to grow the Grouparoo community and build out the team. If you want to build open source data tools that make data reliable, accessible, and actionable, [we would love to chat with you](http://grouparoo.com/jobs).
