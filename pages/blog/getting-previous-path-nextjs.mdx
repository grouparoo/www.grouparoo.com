...
date: "2021-02-17"
author: "Sean C Davis"
pullQuote: "How to find the previous page a user visited before landing on the current page."
image: prev-page-next/next-prev-path.png
tags:
  - engineering
  - notes
---
...
My gut was to start with [`document.referrer`](https://developer.mozilla.org/en-US/docs/Web/API/Document/referrer). I've used that in the past with some success and it seemed like a simple solution.

The [official spec](https://html.spec.whatwg.org/multipage/dom.html#dom-document-referrer-dev) is this:
...
<Image
  centered
  alt="Current and Previous Page Session Storage"
  src="prev-page-next/current-prev-page-session.png"
  width={800}
  height={327}
/>
