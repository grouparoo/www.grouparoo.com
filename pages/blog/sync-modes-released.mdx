...
<Image
  ...
  src="sync-modes-released/sync-mode-select.png"
  width={1228}
  height={250}
/>
...
<Image
  ...
  src="sync-modes-released/export-no-create.png"
  width={1009}
  height={295}
/>
