...
<Image
  ...
  src={require("../../public/posts/mailchimp-destination/connection.png")}
/>
...
<Image
  maxHeight={600}
  alt="How Grouparoo connects to Mailchimp"
  src={require("../../public/posts/mailchimp-destination/api-keys.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/mailchimp-destination/mailchimp-app.png")}
/>

From there, you can create a Destination and start exporting your Profiles and Groups. You can learn more about [creating Destinations here](http://localhost:3001/docs/guides/create-destinations)
