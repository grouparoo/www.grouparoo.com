...
From there, you can create a Destination and start exporting your Profiles and Groups. You can learn more about [creating Destinations here](https://www.grouparoo.com/docs/guides/create-destinations)
