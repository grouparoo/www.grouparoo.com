...
image: apple-m1-js-memory-error/error-graphic.png
tags: [notes]
---
...
Another option is to run your terminal in compatibility mode using Rosetta. You can set your terminal application to _Open using Rosetta_, then reinstall node versions. [See here for more info](https://stackoverflow.com/q/64899827/2241124).
