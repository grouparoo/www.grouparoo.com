...
date: "2021-04-22"
author: "Sean C Davis"
pullQuote: "SQLite is simple but very powerful. Yet, it's a little quirky when it comes to handling types. Let's see how we can protect against it when using Node."
