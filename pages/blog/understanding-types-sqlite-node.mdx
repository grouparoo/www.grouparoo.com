...
date: "2021-04-22"
author: "Sean C Davis"
pullQuote: "SQLite is simple but very cool and powerful. Yet, it's a little quirky when it comes to handling types. Let's explore that goofiness together, and see how we can protect against it when using Node."
image: "understanding-types-sqlite-node/210422-sqlite-types.png"
...
<Image
  alt="SQLite Quirks"
  src="understanding-types-sqlite-node/210422-sqlite-types.png"
  width={1650}
  height={866}
/>
...
Notice what you see on the console. Before the data when into the database, each of our new values was a `number`:
