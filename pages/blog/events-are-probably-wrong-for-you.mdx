...
- The data from this work was then duplicated as we also had [Looker](http://looker.com) pointing to our data warehouse.
...
<Image
  ...
  src={require("../../public/posts/events-are-probably-wrong-for-you/funnel.png")}
/>
