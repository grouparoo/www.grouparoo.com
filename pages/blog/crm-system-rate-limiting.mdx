---
title: "CRM System Rating Limiting Overview"
date: "2021-03-10"
...
At Grouparoo, we have integrated with several CRM (customer relationship management) tools. These often take the form of systems for Sales or email automation tools for Marketing. This article presents an overview of the appraches that we have encountered.
...
<table className="rate-limiting">
  ...
  <tr>
    <td>
      <a href="https://developers.hubspot.com/docs/api/usage-details">Hubpot</a>
    </td>
    <td>100</td>
    <td>10 seconds</td>
...
For example, here is the code that handles the above Intercom headers.
