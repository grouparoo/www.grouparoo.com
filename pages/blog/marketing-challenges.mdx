...
<Image
  ...
  alt="martech 2020"
  src={require("../../public/posts/marketing-challenges/martech2020.png")}
/>
...
> “It’s **incapacitating** to have to rely on someone else. Third party tools are a **source of tension.** Product & Eng is saying over and over to you that your function isn’t important.” - VP of Marketing, [TaskRabbit](http://taskrabbit.com)
...
> “**No one likes working on marketing integrations.** The systems are brittle, it takes a long time, and it’s hard to know if you got the integration right.” - Engineering Manager, [Guideline](http://guideline.com)
...
> “**It’s like pulling teeth** to get engineers to implement new events in Segment.” - Marketing Manager, [Molekule](http://molekule.com)
...
> “Sending a new piece of data from Redshift to Marketo takes anywhere from 4-6 weeks. To work around delays, we manually export CSVs.” - Growth Manager, [Stripe](http://stripe.com)
...
Given everything I've described, while a lot of these challenges are rooted in organizational misalignment, these challenges can also be solved through technology. Here at Grouparoo, we've taken all of these learnings to build a framework and product that makes it easier for engineers to install so they don't have to worry about building and maintaining all of these integrations. Additionally, our product is architected to pull data directly from your core data sources without needing future engineering support. Feel free to share this [blog post](http://grouparoo.com/blog/marketing-challenges) with your engineering team so they can try installing Grouparoo and [reach out](http://grouparoo.com/meet) if you want to learn more.
