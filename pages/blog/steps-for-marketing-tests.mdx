...
image: "steps-for-marketing-tests/01-query.png"
tags: [marketing]
---
...
Grouparoo allows instant feedback on cohort size because they can quickly leverage all the properties created in the previous step. Grouparoo makes this even better because if there is more properties needed, the marketer can just pull it in themself.
