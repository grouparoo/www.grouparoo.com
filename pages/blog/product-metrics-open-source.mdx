...
While we’re still in the early days at Grouparoo, I quickly realized I didn’t have as many of the tools at my disposal as I did in my previous roles. Unlike SaaS products where you have direct access to user and product usage data, we have to piece together metrics from a few different places.

**Discovery metrics:**
We can monitor discovery and adoption in a few different places. We have Google Analytics on our www site, as many people do, to get a rough sense for site visitors and traffic.
...
On Github, on the same **Traffic** tab on a project, you can see how many times your repo has been cloned and the unique number of users who have cloned your project.
