---
title: "Bundling and Distributing Next.js Sites via NPM"
date: "2021-06-03"
author: "Evan Tahler"
...
This is different from Next’s recommendation to alias `next build` to `npm buld` because we are not “deploying” our sites - we are publishing them. Many hosting providers look for a `build` script in your `pacakge.json` to run when the deploy, hence Next.js’ recommendation.
