...
Maria is the first non-engineer to join the team, though she has some skills there, too. We know that it takes more than just working code to make projects like ours successful and we are investing to create a helpfu and welcoming community from the start.
