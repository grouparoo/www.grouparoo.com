...
The 0.7 release of Grouparoo is a huge step forward for data engineers that want to use Grouparoo to reliably sync a variety of types of data to operational tools.

Here are the key features of the release.

- Models enable Grouparoo to work with multiple data schemas at once.
- Grouparoo helps troubleshoot and is more resistant to invalid data
