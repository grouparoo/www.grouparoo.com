...
<Image
  ...
  src={require("../../public/posts/cohort-generation/triangle.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/cohort-generation/retention-rate-graph.png")}
/>
...
<Image
  alt='=IFS($A4<C$1, IFERROR(1/0), EQ($A4,C$1), INDIRECT("R[-1]C[-1]", FALSE)*(1+$B$43), $A4>C$1,INDIRECT(CONCATENATE("R[",-1*($A4-C$1),"]C[0]"), FALSE)*INDIRECT("Model!B"&($A4-C$1+2)))'
  src={require("../../public/posts/cohort-generation/formula-cohort.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/cohort-generation/formula-tests.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/cohort-generation/graph-test-lift.png")}
/>
<Image
  centered
  maxHeight={350}
  alt="More tests each month over 2 years makes a big difference in revenue"
  src={require("../../public/posts/cohort-generation/graph-revenue-lift.png")}
/>
