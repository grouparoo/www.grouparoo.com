...
<Image
  ...
  src={require("../../public/posts/google-sheets-source/new-service-account.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/google-sheets-source/create-service-account.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/google-sheets-source/service-account-key.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/google-sheets-source/service-account-key-data.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/google-sheets-source/grouparoo-app.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/google-sheets-source/app-list.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/google-sheets-source/add-user-to-access.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/google-sheets-source/source-data-preview.png")}
/>
...
<Image
  maxHeight={400}
  alt="Data preview of new source from Google Sheets"
  src={require("../../public/posts/google-sheets-source/source-mapping.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/google-sheets-source/profile-property-rule.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/google-sheets-source/source-rule-and-schedule.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/google-sheets-source/profile.png")}
/>
...
<Image
  ...
  src={require("../../public/posts/google-sheets-source/group.png")}
/>
