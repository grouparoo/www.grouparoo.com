...
- **Enrich**: Update profiles that already exist in the destinations, _enriching_ them with additional data and group membership information. No profiles are added or removed.
