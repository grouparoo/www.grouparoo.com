...
What I was seeing was `git checkout master` still referenced the existence of the old branch I had used. I wanted to get rid of that old one so that it would be an error.
