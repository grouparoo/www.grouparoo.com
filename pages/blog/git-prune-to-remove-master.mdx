...
What I was seeing was `git checkout master` still referenced any old branches I've ever pushed to. I wanted to get rid of that old one so that it would be an error.
