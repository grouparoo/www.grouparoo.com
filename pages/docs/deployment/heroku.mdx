...
title: "Heroku"
date: "2020-08-01"
pullQuote: "Grouparoo is easy to deploy with Heroku."
---

## Example

An example project can be found at https://github.com/grouparoo/app-example-heroku. You can deploy this app with the following button:
...
3. Add the Heroku add-on `heroku-redis` via `heroku addons:create heroku-redis:<PLAN_NAME>`. Learn more about the plan options here: https://devcenter.heroku.com/articles/heroku-redis. This add-on will set the Environment Variable `REDIS_URL` which Grouparoo will automatically use.
4. Push your git project to Heroku, or configure Heroku to monitor your Github repo for changes automatically
