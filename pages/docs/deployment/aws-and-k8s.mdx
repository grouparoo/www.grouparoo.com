...
An example project can be found at https://github.com/grouparoo/app-example-docker
...
Configure Docker Hub to automatically build your docker image from your new repository's main branch. You can see https://github.com/grouparoo/app-example-docker and https://hub.docker.com/r/grouparoo/app-example-docker as an example. The Docker image `grouparoo/app-example-docker#latest` is produced.
