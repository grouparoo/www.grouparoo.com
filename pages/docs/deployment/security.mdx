...
<Image
  ...
  src={require("../../../public/images/docs/deployment/api-key-permissions.png")}
/>
...
<Image
  ...
  src={require("../../../public/images/docs/deployment/environment-app-options.png")}
/>

When configuring your App, you'll see the names of available environment variable options. You will need to copy in th
