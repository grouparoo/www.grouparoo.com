...
- To support the joining of Profile Properties for Records from multiple sources
...
- Ensure that you have enough Memory to keep a days's worth of data in working memory. For 1 million Records x 20 Properties, have at least 8GB of Ram allocated.
