  ...
  return [
    {
      ...
      options: {
        ...
        groupNameField: "Name",
        membershipObject: "AccountContactRole",
        membershipProfileField: "AccountId",
        membershipGroupField: "ContactId",
        profileReferenceField: "AccountId",
        profileReferenceObject: "Account",
        profileReferenceMatchField: undefined,
      },
...
<OptionsList
  options={{
    profileObject: {
      displayName: "profileObject",
      description: "Which object in Salesforce represents a Grouparoo profile?",
    },
    profileMatchField: {
      displayName: "profileMatchField",
      description:
    ...
    membershipProfileField: {
      displayName: "membershipProfileField",
      description:
        "Which object in Salesforce maps the profile object to the group object?",
    },
