...
# populate the system with 1000 profiles, properties, 1000 purchases, and some groups. create config.
grouparoo demo -c purchases

# including the --scale param allows you to control how many profiles you make. e.g. --scale 10 makes 10,000 extra profiles. create config.
grouparoo demo -c purchases --scale 10
```
...
```
➜ grouparoo demo -h
Usage: grouparoo demo [options] <types>
