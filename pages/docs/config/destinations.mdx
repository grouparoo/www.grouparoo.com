...
title: Destinations
date: "2021-06-22"
pullQuote: "Learn how to configure destinations using Grouparoo's Config UI."
---
...
<ImageInBrowserFrame
  centered
  alt="Config UI: Mailchimp Details"
...
Now you can define what groups and what profile properties you want to send to your destination. This mapping defines which profiles get sent to the destination.

<ImageInBrowserFrame
  centered
  alt="Config UI: Choose Group"
...
<ImageInBrowserFrame
  centered
  alt="Config UI: Map Profile Properties"
...
<ImageInBrowserFrame
  centered
  alt="Config UI: Choose Group Membership"
...
Grouparoo's Config UI will write a file to your local filesystem based on your inputs. That file will be placed in the `config/destinations` directory in your Grouparoo project. You can further edit this file locally or through the Config UI.

<Button href="/docs/config/code-config/destinations" variant="outline-primary">
...
Config UI offers an additional benefit of sampling data as you go. If you haven't added any sample profiles, you may want to check that out before moving on to running the app.

<Button href="/docs/config/profiles" variant="outline-primary">
  Add sample profiles
</Button>
