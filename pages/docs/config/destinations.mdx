...
<ImageInBrowserFrame
  centered
  alt="UI Config: Map Profile Properties"
...
Grouparoo's UI Config will write a file to your local filesystem based on your inputs. That file will be placed in the `config/destinations` directory in your Grouparoo project. You can further edit this file locally or through the UI Config.
...
UI Config offers an additional benefit of sampling data as you go. If you haven't added any sample profiles, you may want to check that out before moving on to running the app.
