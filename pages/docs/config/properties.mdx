...
title: Properties
date: "2021-06-22"
pullQuote: "Learn how to configure properties using Grouparoo's Config UI."
---
...
<ImageInBrowserFrame
  centered
  alt="Config UI: Add Property (Option 1)"
...
<ImageInBrowserFrame
  centered
  alt="Config UI: Add Property (Option 2)"
...
<ImageInBrowserFrame
  centered
  alt="Config UI: Configure Property"
...
Grouparoo's Config UI will write a file to your local filesystem based on your inputs. That file will be placed in the `config/properties` directory in your Grouparoo project. You can further edit this file locally or through the Config UI.
