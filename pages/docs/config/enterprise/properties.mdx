...
Now that you have a Source or some Sources ([how to add a Source](/docs/config/sources)), you can start to define Profile Properties. [Profile Properties](/docs/getting-started/product-concepts) are data values associated to the Profiles you have in Grouparoo.
