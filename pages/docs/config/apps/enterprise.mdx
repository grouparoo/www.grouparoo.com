...
- [Creating a Source](/docs/config/sources) to pull Customer data into Grouparoo
- [Creating a Destination](/docs/config/destinations) to Export data from Grouparoo
