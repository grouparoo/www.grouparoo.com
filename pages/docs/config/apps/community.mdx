...
<Alert variant="primary">
  <p className="mb-0">
    ...
    <a href="/docs/config/apps/enterprise">
      use the Enterprise Apps Guide
    </a> instead.
  </p>
</Alert>
...
<Alert variant="warning">
  <p className="mb-0">
    ...
    <a href="/docs/installation">
      initialized the Grouparoo application locally
    </a>
    .
  </p>
</Alert>
...
Note here that `data_warehouse` is the ID for the application. An ID is always required when generating a config object.
