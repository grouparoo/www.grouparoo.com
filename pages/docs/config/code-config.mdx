...
title: "Code Config"
date: "2021-06-23"
pullQuote: "Use the Grouparoo CLI to configure your Grouparoo instance. The Grouparoo CLI generates configuration files that declare how you want to sync data."
---
...
<Alert variant="primary">
  <p className="mb-0">
    Grouparoo's recommend way to configure the application is through UI Config.{" "}
    <a href="/docs/config">See here</a> for more information.
  </p>
</Alert>
