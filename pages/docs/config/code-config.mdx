...
Grouparoo will format the `id`s provided to the [`grouparoo generate`](/docs/running-grouparoo/commands#generate) command to match these rules

## Related CLI Commands

- Use the [`grouparoo generate`](/docs/running-grouparoo/commands#generate) command to help build your config files from templates
- Use the [`grouparoo validate`](/docs/running-grouparoo/commands#validate) command to test your configuration files and look for errors
- Use the [`grouparoo apply`](/docs/running-grouparoo/commands#apply) command to apply your new configuration changes to your database
