...
Destinations are the last step in the Grouparoo configuration process. That means you should have already configured at least one [App](/docs/running/ui-enterprise/apps), [Source](/docs/config/destinations/enterprise), [Property](/docs/config/properties/enterprise), and [Group](/docs/config/groups/enterprise).
