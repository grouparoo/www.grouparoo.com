...
The very first Source you create in Grouparoo generates a primary key for all Profiles. This [Property](/docs/config/properties/community) must be unique to all of your Profiles, and is commonly a user ID or email address. Grouparoo will generate one Profile per unique value for this Property.
