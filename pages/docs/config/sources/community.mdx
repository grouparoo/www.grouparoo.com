...
Certain plugins may provide complex source generation options. This means that is you have a valid [`App`](/docs/config/apps) already configured and applied, Grouparoo can inspect that app and generate a Source and Properties automatically for you. Learn more about this from the [Generate CLI Command documentation](/docs/cli/config#complex-source-generation).
