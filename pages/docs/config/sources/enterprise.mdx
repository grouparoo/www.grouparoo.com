...
Now that you've added an App ([how to add Apps](/docs/config/apps)), your first step is to create a [Source](/docs/getting-started/product-concepts). A Source is a definition for how you pull data from an App into Grouparoo.
...
After you've chosen the database table that contains your user data, you will need to indicate what makes your users unique. Often a unique identifier is a `user id`, `uid`, or `email`. If you already have a unique Profile Property defined in Grouparoo, you can map your Source to that Profile Property. If your Source has a new way of identifying profiles uniquely, you can create a new unique Profile Property.
...
- [Creating Profile Properties](/docs/config/properties)
- [Creating Groups](/docs/config/groups)
- [Creating a Destination](/docs/config/destinations)
