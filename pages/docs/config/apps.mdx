...
Grouparoo's UI Config will write a file to your local filesystem based on your inputs. That file will be placed in the `config/apps` directory in your Grouparoo project. You can further edit this file locally or through the UI Config.
