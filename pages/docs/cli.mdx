...
date: "2021-02-08"
pullQuote: "Detailed information about the Grouparoo CLI commands and how to use these commands in your environments"
---
...
- [`grouparoo sync <record> (--no-export)`](/docs/cli/run#sync) - Import and Export 1 Record fully and output a snapshot.
- [`grouparoo run (--web) (--reset) (--no-export)`](/docs/cli/run#run) - Run the application and stop after every Record has been imported and exported as needed.
