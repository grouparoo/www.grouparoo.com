...
1. Create a github repo, public or private, to hold your Code Config. Do _not_ push your code config yet!
    ...
    * Follow the standard github steps to sync your empty `main` branch up.
    * Make a new branch for your Code Config, and github action
    * `git checkout -B my-cloud-workflow-branch`
    * Use `grouparoo config` to setup your Code Config. Make sure to commit it!

2. Create the workflow for Grouparoo Cloud and push it up
    * `mkdir -p .github/workflows`
    * `touch .github/workflows/grouparoo-cloud.yml`
    * Paste [this](https://raw.githubusercontent.com/grouparoo/app-example-cloud/main/.github/workflows/grouparoo-cloud.yml?token=ABF42DR7YI226UKGVOEFI43BRZ346) into `grouparoo-cloud.yml`.
    * `git add .github`
