...
The following operations are available to use as Grouparoo filters. Each operation is followed by the shortened version that is used in the configuration files:
