---
title: "Grouparoo Integrations"
date: "2021-10-12"
section: "installation"
pullQuote: "Grouparoo can integrate seamlessly with your existing data stack. Plugins add more Apps, Sources, and Destinations."
---
...
<Image
  thumbnail
  src="docs/plugins/install-plugin-config.png"
  alt="Installing a Grouparoo Plugin"
  width={1010}
  height={517}
/>

The Grouparoo command line tool can also be used to add a Plugin to your project via `grouparoo install [package]`. You can learn more about the `grouparoo install` command [here](/docs/cli/setup). So, if you wanted to install the `@grouparoo/mysql` Plugin, you would run:
...
In addition to our plugins, you can use features such as our [Orchestration Tools](/docs/running/orchestration) to integrate with tools such as [Airflow](https://airflow.apache.org/), [Dagster](https://dagster.io/), or [dbt](/docs/integrations/grouparoo-dbt).
