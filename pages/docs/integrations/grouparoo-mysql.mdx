...
In [secondary sources](https://www.grouparoo.com/docs/config/code-config/sources), choose the MySQL column that ties this table to your primary source. This will often be a foreign key in your table.
