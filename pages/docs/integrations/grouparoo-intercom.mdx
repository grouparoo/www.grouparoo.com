...
<table className="docTable">
  <tbody>
    <tr>
      ...
      <td>Export Records to contacts in an Intercom account.</td>
    </tr>
  </tbody>
</table>
...
<tablebody>
  <tr>
    <td>
      <strong>Sync Mode</strong> (required)
    </td>
    <td>
...
We strive to keep our documentation accurate, easy to use, and up to date. If you notice that something has changed or is not addressed in the process of setting up your Grouparoo connection with Intercom, please let us know.
...
<style>
  {`
    ...
    .docTable td:first-child, th:first-child {
      width: 25%;
    }
