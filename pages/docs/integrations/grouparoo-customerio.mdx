...
To connect Customer.io to Grouparoo, you [create an App](/docs/config/apps). This step will specify how Grouparoo can connect to Customer.io with your account information to prepare for setting up a new Destination in Grouparoo.
