...
<DestinationSyncModes appName="Salesforce" recordsName="Accounts" />

For more information on what all these Destinations attributes mean and how to configure them, see the [configuration files doc](/docs/support/config-files#destinations).
...
<DestinationSyncModes appName="Salesforce" recordsName="Objects" />
...
<ImageInBrowserFrame
  src="/images/docs/integrations/salesforce/export-objects/options.png"
  alt="Salesforce Export Objects Options"
  width={750}
  height={827}
/>
<br />
...
<ImageInBrowserFrame
  src="/images/docs/integrations/salesforce/export-objects/properties.png"
  alt="Salesforce Export Objects Properties"
  width={750}
  height={391}
/>
<br />
