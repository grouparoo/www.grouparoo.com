...
In addition to mapping Grouparoo Properties to Zendesk User Properties, you can use Grouparoo Groups to apply tags to Mailchimp Users.

This tagging process starts by selecting a group from the dropdown menu in the Send Group box. The Zendesk Tag name will default to the name of the Grouparoo Group you have selected, but you can edit the Mailchimp Tag name as you want it to appear. Grouparoo will not affect tags with different names that were created and applied directly through Zendesk.
