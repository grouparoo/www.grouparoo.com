...
When setting an Environment Variable to use with Grouparoo, you'll be using the pattern: `GROUPAROO_OPTION__{topic}__{name}={value}`. ⚠️ **Note the double-underscores before the topic and name.**
...
When configuring your App, you'll see the names of available environment variable options.
