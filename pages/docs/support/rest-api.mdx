...
2. Give your API Key a name. An API Key will be generated an yu will be prompted to set permissions for this API.
...
To see examples of how to use your API key in the Swagger docs, click "Authorize" and enter your API Key (if pasting in your API Key, remember to check there's no extra whitespace!).
