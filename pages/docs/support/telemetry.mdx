...
title: "Telemetry"
date: "2020-08-01"
pullQuote: "Grouparoo collects default-anonymous telemetry data about general usage. Participation in this anonymous program is optional"
---
...
- Total counts of various Models within your cluster - i.e: the number of Records, Groups, Apps, etc. your cluster has created.
...
const payload = {
  ...
  metrics: [
    ...
    // usage counts
    { collection: "totals", topic: "records", aggregation: "count", count: 100, },
...
You can see the full details of which data we are collecting and how we collect it [here](https://github.com/grouparoo/grouparoo/blob/main/core/api/src/modules/telemetryReporters.ts).
...
We take your privacy and our security very seriously. If you find that information is being sent to our Telemetry servers, or that our Telemetry tooling can be exploited, please [let us know in accordance with our Security Policy](/docs/support/security)
