...
**TODO**: See [this pull request](https://github.com/grouparoo/app-example/pull/103/files), which contains the changes to the `app-example` project. This is a good example for upgrading to v0.3 of Grouparoo for your app. All of the changes required will be in your `package.json` file.
