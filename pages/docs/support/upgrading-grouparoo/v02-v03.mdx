...
2. If you are using the **customer.io** plugin with code config, you will need to edit the app's configuration file and change the `type` from `customer.io` to `customerio`.
3. Depending on how you've been configuring destinations, some extra steps may be needed:
