...
See [this pull request](https://github.com/grouparoo/app-example/pull/103/files), which contains the changes to the `app-example` project. This is a good example for upgrading to v0.2 of Grouparoo for your app. You wil want to do the following:
