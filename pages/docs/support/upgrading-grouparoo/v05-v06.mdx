...
As of v0.6, Profiles are automatically deleted from Grouparoo when they've been removed from their primary source. This can be useful to make sure that profiles are removed from all of your destinations, which can be particularly helpful for GDPR compliance.
