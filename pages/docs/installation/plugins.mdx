...
Please ensure that the versions of your plugins match the version of `@grouparoo/core` that you are using **exactly**. If you need to install a specific version of a plugin to match `@grouparoo/core`, you can:
...
Use an `.npmrc` file in your Grouparoo project. This can be checked into your project and Docker images if kept private. The contents of the file will look like:
