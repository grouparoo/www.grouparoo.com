...
Grouparoo is easy to deploy with [Docker](https://www.docker.com/) and [Docker Compose](https://docs.docker.com/compose/). An example project can be found at https://github.com/grouparoo/app-example
