...
<Tab
  ...
  style={{ padding: "1rem" }}
>
<h5>Install Node.js on Ubuntu, Red Hat, or AWS Linux</h5>
...
<Tab
  ...
  style={{ padding: "1rem" }}
>
<h5>Install Postgres and Redis on Ubuntu, Red Hat, or AWS Linux</h5>
<em>... or other Linux distributions that use the `yum` package manager.</em>
...
- CentOS: https://www.digitalocean.com/community/tutorials/how-to-install-and-use-postgresql-on-centos-7
- Amazon Linux https://techviewleo.com/install-postgresql-12-on-amazon-linux/
...
```json
{
  ...
  "grouparoo": {
    "plugins": ["@grouparoo/ui-enterprise"]
  }
}
```
