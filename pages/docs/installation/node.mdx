...
<Tab
  ...
  style={{ padding: "1rem" }}
>
<h5>Grouparoo is not not supported on Windows</h5>
<p>However, you can use the <a target="_blank" href="https://docs.microsoft.com/en-us/windows/wsl/install-win10">Windows subsystem for Linux</a> to run Ubuntu and follow the steps in in the Ubuntu tab</p>
</Tab>
</Tabs>
