...
<SectionDivider
  ...
  width="713"
  height="387"
  content="Grouparoo's queryable data structure makes it easy to create records -- even from historical data.  You can configure customer records from the developer UI on our community edition, or straight from the app UI with our enterprise product."
  imageLeft="false"
  browser="true"
/>
