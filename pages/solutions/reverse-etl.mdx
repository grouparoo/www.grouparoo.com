...
In Grouparoo terms, that means first connecting to Sources -- which could be anything from Google Bigquery to Snowflake to a Postgres database, or any one of our 20+ integration options. Then, you can start defining Profile Properties.
...
From here, Grouparoo allows you to define what Profile and Property data you want to send to your business tools like CRMs, marketing automation platforms, and others. We call these Destinations, and we’ve built 20+ integration apps (and we’re launching more all the time!).
...
Grouparoo also keeps all of your profile data up-to-date and ensures that everything we send to a destination was recently checked against the source of truth. That way, you can rest with a sense of security that your data is accurate and current.
