...
export default function RedshiftPage() {
  return (
    <>
      ...
      <Container>
        <Row>
          <Col lg={5} md={12}>
            <br />
            <h1>
              Sync Redshift customer data with all of your 3rd party tools
            </h1>
            <p>
              Grouparoo's Redshift integration allows you to sync all of your
              customer data that lives in your Redshift data warehouse with
          ...
          <Row>
            ...
            <Col lg={6} md={6} xs={12}>
              ...
              <ul>
                ...
                <li>
                  Easily make cohorts and segments out of your Redshift data
                </li>
                <li>
        ...
        <Row>
          <Col>
            ...
            <p>
              ...
              your Redshift DB. You can pull this data in with Grouparoo's help
        ...
        <Row className="align-items-center">
          <Col md={4}>
            ...
            <h3 className="integrationsBlueH3">
              Easily connect your Redshift data
            </h3>
            <p>
              Since Grouparoo is installed in your cloud infrastructure, you can
              easily point Grouparoo to any number of Redshift instances you may
              have running.
            </p>
          </Col>
          <Col md={8}>
      ...
      <br />
      <div
        id="Grouparoo Connects with Redshift"
        className="bg-dark text-white"
        style={{ paddingTop: 50, paddingBottom: 50 }}
      >
        <Container>
          <Row>
            <Col style={{ textAlign: "center" }}>
              <h2>Send your customer data from Redshift to these tools</h2>
              <br />
