    ...
    <Container fluid className={`pipes ${styles.container}`}>
      ...
      <Row>
        <Col>
          ...
          <h3>Control</h3>
          <p>
            Grouparoo runs in your environment so you always have access to all
            the code and the data. Use it however you want.
          </p>
        </Col>
        <Col>
      ...
      <Row>
        <Col>
          ...
          <h3>Privacy</h3>
          <p>
            You get to choose exactly what data gets sent to each tool. And you
            give them less because it was only needed to make the groups.
          </p>
        </Col>
        <Col>
